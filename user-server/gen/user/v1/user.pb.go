...
type GetUserRequest struct {
	...
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // 1 はフィールド番号
...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\vUserService\x12<\n" +
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\x18.user.v1.GetUserResponseBAZ?github.com/koshifutami/grpc-apps/user-server/gen/user/v1;userv1b\x06proto3"
